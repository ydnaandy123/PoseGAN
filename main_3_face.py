...
flags = tf.app.flags
flags.DEFINE_string("dataset_name", "face", "The name of dataset [celebA, mnist, lsun]")
flags.DEFINE_string("mode", "test", "network mode [train, test]")

flags.DEFINE_string("image_dir", "/data/vllab1/Github/BEGAN-tensorflow/data/CelebA/images", "The directory of images")

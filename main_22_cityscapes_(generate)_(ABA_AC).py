import numpy as np
from model_aba_ac import ABAACCity
from utils_lite import pp, show_all_variables, config_check_directory
import tensorflow as tf

flags = tf.app.flags
# Experiments setting
flags.DEFINE_string("name", "cityscapes_(generate)_(aba_ac)", "The name of dataset [celebA, mnist, lsun]")
...
flags.DEFINE_string("image_dir", "./dataset/CITYSCAPES_DATASET/train/image", "The directory of images")
flags.DEFINE_string("condition_dir", "./dataset/CITYSCAPES_DATASET/train/semantic_color", "The directory of conditions")
...
flags.DEFINE_string("image_dir_val", "./dataset/CITYSCAPES_DATASET/val/image", "The directory of images")
flags.DEFINE_string("condition_dir_val", "./dataset/CITYSCAPES_DATASET/val/semantic_color", "The directory of conditions")
# Hyper parameter
...
flags.DEFINE_float("lambda_gAB", 100.0, "L1 lambda hyper parameter [10.0]")
flags.DEFINE_float("lambda_gBA", 100.0, "L1 lambda hyper parameter [10.0]")
flags.DEFINE_float("lambda_gC", 100.0, "L1 lambda hyper parameter [10.0]")
# Directories

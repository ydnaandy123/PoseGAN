...
flags = tf.app.flags
flags.DEFINE_string("dataset_name", "heatmap", "The name of dataset [celebA, mnist, lsun]")
flags.DEFINE_string("mode", "test", "network mode [train, test]")

flags.DEFINE_string("image_dir", "/data/vllab1/CVPR/dataset/train/heatmap", "The directory of images")

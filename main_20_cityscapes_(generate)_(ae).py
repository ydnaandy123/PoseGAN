import numpy as np
from model_generate import GenerateCity
from utils import pp, show_all_variables, config_check_directory
import tensorflow as tf

flags = tf.app.flags
# Experiments setting
flags.DEFINE_string("name", "cityscapes_(generate)_(ae)", "The name of dataset [celebA, mnist, lsun]")
...
flags.DEFINE_string("condition_dir", "./dataset/CITYSCAPES_DATASET/train/semantic_id", "The directory of conditions")
...
flags.DEFINE_integer("condition_dim", 1, "The dimension of the condition [3]")
# Network sample(testing) feed
flags.DEFINE_string("image_dir_val", "./dataset/CITYSCAPES_DATASET/train/image", "The directory of images")
flags.DEFINE_string("condition_dir_val", "./dataset/CITYSCAPES_DATASET/train/semantic_id", "The directory of conditions")
# Hyper parameter

import numpy as np
from model_cycle import CycleCity
from utils_lite import pp, show_all_variables, config_check_directory
import tensorflow as tf

flags = tf.app.flags
# Experiments setting
flags.DEFINE_string("name", "cityscapes_(generate)_(cycle)", "The name of dataset [celebA, mnist, lsun]")
...
flags.DEFINE_float("lambda_con", 10.0, "L1 lambda hyper parameter [10.0]")
# Directories

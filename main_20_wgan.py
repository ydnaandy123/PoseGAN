...
"""
import numpy as np
from model_wgangp import WGANGP
from utils import pp, show_all_variables, config_check
import tensorflow as tf

flags = tf.app.flags
# Main
flags.DEFINE_string("name", "mpii_heatmap_compress_(n)condition_(n)g1", "The name of dataset [celebA, mnist, lsun]")
flags.DEFINE_string("mode", "train", "network mode [train, test]")
flags.DEFINE_integer("sample_num", 25, "The number of sample images [64]")

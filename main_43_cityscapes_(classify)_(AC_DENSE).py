import numpy as np
from model_ac_dense import ACDENSECity
from utils_lite import pp, show_all_variables, config_check_directory
import tensorflow as tf

flags = tf.app.flags
# Experiments setting
flags.DEFINE_string("name", "cityscapes_(classify)_(ac_dense)", "The name of dataset [celebA, mnist, lsun]")
